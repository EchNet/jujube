	...
	private class Builder
	{
			...
			throws ConfigException
		{
			try {
				...
				return TypeCoercionSupport.coerce(typeHint, matter);
			}
		...
		private Object materializeList(Document dq, Class<?> typeHint)
			throws IOException
		{
			return Document.class.equals(typeHint) ? dq.copy() : listProperties(dq, typeHint.isArray() ? typeHint.getComponentType() : Object.class);
		}
